...
const PROJECT_URL = process.env.PROJECT_URL || 'https://webs.spiritfr.eu.org';    // 需要上传订阅或保活时需填写项目分配的url,例如：https://google.com
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'galaxy.spiritfr.eu.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjE5YmM1ODgzYzBmYzc5MzViNDAxM2FhY2I5MDc3OWEiLCJ0IjoiYWI3NDk3ZmItZWVlYy00NmNmLThjYjgtNmNjNjRhZWE5YWNiIiwicyI6Ik4yTmtaRGcxWVdRdE9HUXhOUzAwTWpsaUxXRmtOVE10Wm1SaU5HWm1abU14WXpobSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
